...
public static class Dj {
	...
	public static System.Exception Crash(string msg) {
		return new System.Exception(prefix+msg);
	}
	public static System.Exception Crashf(string msg, params object[] args) {
		return new System.Exception(string.Format(prefix+msg, args));
	}
}